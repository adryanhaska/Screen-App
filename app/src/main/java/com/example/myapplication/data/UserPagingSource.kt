...
class UserPagingSource(private val apiService: ApiService) : PagingSource<Int, User>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, User> {
        return try {
            ...
            println("UserPagingSource: Loading page $page")
            ...
            LoadResult.Page(
                ...
                println("UserPagingSource: Loaded page $page with ${responseData.data.size} items")
            }
        } catch (exception: Exception) {
            println("UserPagingSource: Error loading page - ${exception.message}")
